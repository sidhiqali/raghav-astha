...
function updateMusic() { $('music').classList.toggle('playing', !song.paused); $('music').setAttribute('aria-label', CONFIG.song ? (song.paused ? 'Play our song' : 'Pause our song') : 'Music information'); $('play-icon').textContent = CONFIG.song ? (song.paused ? '▶' : 'Ⅱ') : '♪'; $('music-caption').textContent = CONFIG.song ? (song.paused ? 'Tap to play' : 'Tap to pause') : 'Our soundtrack'; }
